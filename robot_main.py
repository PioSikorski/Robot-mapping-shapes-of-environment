...
from consts import PI_IP_ADDRESS, SERVER_PORT, LEFT_ENCODER_SENSOR_PIN, RIGHT_ENCODER_SENSOR_PIN, LEFT_SENSOR_DISTANCE_FROM_ROBOT_CENTRE_X, LEFT_SENSOR_DISTANCE_FROM_ROBOT_CENTRE_Y, MIDDLE_SENSOR_DISTANCE_FROM_ROBOT_CENTRE, RIGHT_SENSOR_DISTANCE_FROM_ROBOT_CENTRE_X, RIGHT_SENSOR_DISTANCE_FROM_ROBOT_CENTRE_Y, DEBUG
